# adventureworks_dab_poc

The 'adventureworks_dab_poc' project was generated by using the lakeflow-pipelines template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] adventureworks_dab_poc_etl` to your workspace.

...
# Produces a raw silver fact_sales with the natural geography_key
# (address_id + postal_code concat) and customer_id unresolved.
# Dimension enrichment and geography normalization happen in the
# Gold layer via geography_mapping + dim joins.
# ============================================================
...
def fact_sales_batch():
    ...
    return (
        ...
        .select(
            ...
            col("soh.ModifiedDate").alias("modified_date"),  # required for SCD1 sequence_by
        )
    )
